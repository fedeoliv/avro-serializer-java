...
public class EventTypes {
    ...
    public static final String BalanceUndoStarted = "BalanceUndoStarted";
    public static final String BalanceUndoFinished = "BalanceUndoFinished";
    ...
    public static final String SignalingUndoStarted = "SignalingUndoStarted";
    public static final String SignalingUndoSucceded = "SignalingUndoSucceded";
